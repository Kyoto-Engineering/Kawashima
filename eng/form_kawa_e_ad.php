...
//mail from customer
            $to_mail = "jarin.h@keal.com.bd";   
            $email_subject="Kawashima Product Inquiry";
            
            $email_message="Sent From   : ".$_POST['inputForm:mailaddress']."\r\n".$_POST['inputForm:tx19']."\r".$_POST['inputForm:tx11']."\r\n".
            		   "Inquired By         : ".$_POST['inputForm:tx14']."\r\n".
            		   "Phone No           : ".$_POST['inputForm:tx15']."\r\n".
            		   "PRODUCT WEIGHT PER BAG:(g)     : ".$_POST['inputForm:tx31']."\r\n".
            		   "BAG SIZE            : ".$_POST['inputForm:tx32']."\r\n".
                   "PACKAGING MATERIAL  : ".$_POST['inputForm:tx33']."\r\n\r\n".
                     
            		   
            		   
            		   
            		  "OTHER REQUIREMENT: " .$_POST['inputForm:ta11']."\r\n\r\n";
            		    
            		    
            $headers = 'From: '.$_POST['inputForm:mailaddress']."\r\n".
                     'Reply-To:'.$_POST['inputForm:mailaddress'] . "\r\n" .
